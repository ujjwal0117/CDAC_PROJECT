...
public class TrackingController {
    ...
    /**
     * Get delivery person's live location for an order
     * Customer facing API
     */
    @GetMapping("/order/{orderId}/delivery-location")
    public ResponseEntity<LocationUpdateResponse> getDeliveryLocation(@PathVariable Long orderId) {
        return ResponseEntity.ok(trackingService.getOrderDeliveryLocation(orderId));
    }
