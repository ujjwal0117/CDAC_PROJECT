...
export const userAPI = {
     ...
     * @param {boolean} enabled - true to enable, false to ban
     * @returns {Promise<Object>}
     */
    setEnabled: async (userId, enabled) => {
        return apiRequest(`/api/users/${userId}/enabled`, {
            method: 'PUT',
...
export const restaurantAPI = {
     ...
     */
    approve: async (id) => {
        return apiRequest(`/api/restaurants/${id}/approve`, {
            method: 'PUT'
        });
    },
     ...
     */
    getPending: async () => {
        return apiRequest('/api/restaurants/admin/pending', { method: 'GET' });
    },
