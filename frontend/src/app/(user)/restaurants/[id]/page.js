...
export default function RestaurantMenu({ params }) {
    ...
    const filteredItems = menuItems.filter(item => {
        ...
        return isAvailable && matchesSearch && matchesVeg;
    });
                    ...
                    <div>
                        ...
                        <div className="flex items-center space-x-4 text-sm text-gray-300">
                            ...
                            <span className="flex items-center text-blue-400 font-medium">
                                <MapPin className="w-4 h-4 mr-1" /> {restaurant.stationName || 'Assigned Station'}
                            </span>
                        </div>
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                                <div className="relative flex-1 max-w-md">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2 rounded-xl border border-gray-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-100 outline-none transition"
