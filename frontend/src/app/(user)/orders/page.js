                            ...
                            <div key={order.id} className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow">
                                ...
                                <div className="flex justify-between items-center pt-4 border-t border-gray-50">
                                    <div>
                                        ...
                                        <p className="text-[10px] text-gray-400 uppercase tracking-wider font-bold -mt-1">Inclusive of all taxes</p>
                                        <p className="text-sm text-gray-500 mt-1">{order.items?.length || 0} items • ID: #{order.id}</p>
                                    </div>
