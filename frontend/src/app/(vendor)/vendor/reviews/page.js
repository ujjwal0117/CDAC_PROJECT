...
export default function VendorReviewsPage() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // 1. Get Vendor's Restaurant (for UI context)
                ...
                // 2. Get All Reviews for this Vendor
                console.log("Fetching all reviews for vendor...");
                const reviewsData = await reviewAPI.getVendorReviews();
                console.log("Fetched vendor reviews:", reviewsData);
